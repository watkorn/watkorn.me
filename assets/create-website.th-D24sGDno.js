var e={html:`<p>เว็บนี้คือบ้านของ writeup CTF และโปรเจกต์ข้างเคียงของผม และตัวมันเองก็เป็นโจทย์ด้วย หน้าแรกคือ terminal ที่มี <strong>flag ซ่อนอยู่ 8 อัน</strong> ทั่วเว็บ ถ้าคุณเป็นสาย security วิธีรู้จักผมที่เร็วที่สุดคือลองเจาะเว็บผมดู</p>
<h2 id="เป้าหมาย">เป้าหมาย<a class="heading-anchor" href="#เป้าหมาย" aria-label="ลิงก์ไปหัวข้อนี้: เป้าหมาย">#</a></h2>
<ol>
...
<h2 id="ทำงานยังไง">ทำงานยังไง<a class="heading-anchor" href="#ทำงานยังไง" aria-label="ลิงก์ไปหัวข้อนี้: ทำงานยังไง">#</a></h2>
...
<h2 id="ความปลอดภัย">ความปลอดภัย<a class="heading-anchor" href="#ความปลอดภัย" aria-label="ลิงก์ไปหัวข้อนี้: ความปลอดภัย">#</a></h2>
...
<h2 id="ctf-ข้างใน">CTF ข้างใน<a class="heading-anchor" href="#ctf-ข้างใน" aria-label="ลิงก์ไปหัวข้อนี้: CTF ข้างใน">#</a></h2>
<p>terminal พูดภาษา shell ได้นิดหน่อย: <code>ls -la</code>, <code>cd</code>, <code>cat</code>, <code>open &lt;post&gt;</code>, <code>hint</code>, <code>submit &lt;flag&gt;</code> มีประวัติคำสั่งและเติมคำด้วย Tab มี 8 ด่านใน 2 ซีซัน (10 ถึง 80 แต้ม) ซ่อนไว้ในจุดที่ผู้เล่นควรหัดมอง flag ตรวจด้วย <strong>SHA-256 hash อย่างเดียว</strong> อ่าน JavaScript ไปก็ไม่ได้คำตอบ ความคืบหน้าอยู่ที่<a href="/th/achievements">หน้าความสำเร็จ</a> เก็บไว้แค่ในเบราว์เซอร์ของคุณ</p>
<p>มี test ยืนยันว่าทุก flag หาเจอได้จริงบนเว็บที่ build แล้วและตรงกับ hash ผมจะได้ไม่เผลอปล่อยด่านที่แก้ไม่ได้ออกไป</p>
<h2 id="ดีไซน์-handheld-quest">ดีไซน์: Handheld Quest<a class="heading-anchor" href="#ดีไซน์-handheld-quest" aria-label="ลิงก์ไปหัวข้อนี้: ดีไซน์: Handheld Quest">#</a></h2>
...
<h2 id="ตัวเลข">ตัวเลข<a class="heading-anchor" href="#ตัวเลข" aria-label="ลิงก์ไปหัวข้อนี้: ตัวเลข">#</a></h2>
<ul>
...
<h2 id="สิ่งที่ได้เรียนรู้">สิ่งที่ได้เรียนรู้<a class="heading-anchor" href="#สิ่งที่ได้เรียนรู้" aria-label="ลิงก์ไปหัวข้อนี้: สิ่งที่ได้เรียนรู้">#</a></h2>
<ul>
...
<h2 id="stack">Stack<a class="heading-anchor" href="#stack" aria-label="ลิงก์ไปหัวข้อนี้: Stack">#</a></h2>
