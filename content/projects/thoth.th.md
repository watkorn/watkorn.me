...
> **อยู่นอกขอบเขต** Thoth ใช้กับคดีจริง จึง**ไม่ใช่**ส่วนหนึ่งของ CTF ในเว็บนี้ ขอความร่วมมืออย่าทดสอบเจาะระบบนี้ ถ้าคิดว่าเจอปัญหา แจ้งผมเป็นการส่วนตัวแทน ช่องทางติดต่ออยู่ใน [security.txt](/.well-known/security.txt)
